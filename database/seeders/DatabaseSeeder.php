...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        |--------------------------------------------------------------------------
        | On recherche uniquement par email.
        | Le compte ne sera pas recréé à chaque exécution.
        */
        User::updateOrCreate(
            [
            ...
            [
                'name' => 'Admin IMARDOS',
                'password' => Hash::make('IMARDOS_ADMIN_2024'), // le mot de passe est hashé pour la sécurité !
            ]
        );
        ...
        */
        ...
        Action::updateOrCreate(
            ...
            [
                ...
                'status' => 'Terminé',
                'image' => 'https://images.unsplash.com/photo-1497633762265-9d179a990aa6?w=200',
            ]
        );
        ...
        */
        ...
        Event::updateOrCreate(
            [
                'title' => 'Journée Santé Maternelle',
            ],
            [
                'location' => 'Lokossa',
                'date' => '2024-09-12',
        ...
        */
        ...
        Gallery::updateOrCreate(
            ...
            [
                ...
                'image' => 'https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?w=200',
            ]
        );
